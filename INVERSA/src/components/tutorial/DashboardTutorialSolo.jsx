...
const DashboardTutorialSolo = ({
  ...
  const tutorials = [
    {
      targetId: 'tutorial-tab-solo',
      title: 'Solo Projects',
      description: 'Kelola project pribadi yang kamu buat sendiri. Semua tulisanmu tersimpan rapi di sini.',
    },
    {
      targetId: 'tutorial-create-project',
      title: 'Create Project',
      description: 'Buat project baru untuk mulai menulis. Kamu bisa membuat cerita, artikel, atau catatan pribadi.',
    },
    {
      targetId: 'tutorial-my-projects',
      title: 'My Projects',
      description: 'Daftar seluruh project solo yang kamu miliki. Klik project untuk melanjutkan menulis.',
    },
  ];
...
export default DashboardTutorialSolo;