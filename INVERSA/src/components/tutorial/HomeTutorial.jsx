...
const HomeTutorial = ({
  ...
  onSkip,
  onPrevious,
  // Props baru untuk dukungan mobile menu
  openMobileMenu,   // Fungsi async: () => Promise<void> (tunggu animasi selesai)
  closeMobileMenu,  // Fungsi: () => void
}) => {
  const tutorials = [
    {
      targetId: 'tutorial-home',
      title: 'Home',
      description: 'Halaman utama INVERSA. Menampilkan berbagai karya dan rekomendasi untukmu.',
    },
    {
      targetId: 'tutorial-explore',
      title: 'Explore',
      description: 'Cari karya berdasarkan judul atau genre. Temukan cerita-cerita menarik.',
    },
    {
      targetId: 'tutorial-dashboard',
      title: 'Dashboard',
      description: 'Kelola project solo maupun tim. Lihat statistik dan aktivitas menulismu.',
    },
    {
      targetId: 'tutorial-bento-dashboard',
      title: 'Your Dashboard',
      description: 'Ringkasan aktivitas akun milikmu. Total proyek, anggota tim, dan notifikasi.',
    },
    {
      targetId: 'tutorial-followed-projects',
      title: 'Followed Projects',
      description: 'Proyek yang kamu ikuti akan muncul di sini untuk akses cepat.',
    },
    {
      targetId: 'tutorial-reading-history',
      title: 'Reading History',
      description: 'Lanjutkan membaca chapter terakhir yang pernah kamu buka.',
    },
    {
      targetId: 'tutorial-profile',
      title: 'Profile',
      description: 'Kelola akun dan informasi profil. Ubah foto, bio, dan preferensi.',
    },
  ];
