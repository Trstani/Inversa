  ...
  const tutorials = [
    {
      targetId: 'story-idea',
      title: 'story idea',
      description: 'Tambahkan ide cerita untuk pengembangan Chapter.',
    },
    {
      targetId: 'discussion',
      title: 'discussion',
      description: 'Berikan Feedback dan ber diskusilah dengan anggota team lain.',
    },
    {
      targetId: 'notes',
      title: 'notes',
      description: 'Berikan catatan untuk di pengingat progress.',
    },
    {
      targetId: 'contribution',
      title: 'contribution',
      description: 'Kontribusi Kamu untuk tim akan di catat di sini.',
    },
  ];
...
export default BrainstormTutorialIdea;