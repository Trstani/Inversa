    ...
    <div className="mb-6">
      ...
      <div className="mb-6 flex flex-col sm:flex-row gap-2">
        ...
        <select
          ...
          onChange={(e)=>onSelectChapter(
            e.target.value
              ? parseInt(e.target.value)
              : null
          )}
          className="px-4 py-2 rounded bg-light-background dark:bg-dark-background border border-light-accent/20 dark:border-dark-accent/20 text-light-primary dark:text-dark-primary focus:outline-none focus:border-light-accent dark:focus:border-dark-accent"
        >
        ...
        <input
          ...
          className="flex-1 px-4 py-2 rounded bg-light-background dark:bg-dark-background border border-light-accent/20 dark:border-dark-accent/20 text-light-primary dark:text-dark-primary placeholder-light-secondary dark:placeholder-dark-secondary focus:outline-none focus:border-light-accent dark:focus:border-dark-accent"
        />

        <button
          onClick={onAddIdea}
          disabled={!newIdeaInput.trim()}
          className="px-4 py-2 rounded bg-light-accent dark:bg-dark-accent text-white hover:opacity-90 disabled:opacity-50 transition font-medium flex items-center gap-2"
        >
